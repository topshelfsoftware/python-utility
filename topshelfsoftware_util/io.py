...
@contextmanager
def cdtmp(
    tmpdir: str = None, sub_dirname: str = None, cleanup: bool = True
) -> Iterator[None]:
    ...
    >>> # Directory is now back to '/home' and the temporary directory
    >>> # no longer exists
    """
    ...
    try:
        ...
        prev_dir = gettempdir()
        logger.warning(
            f"Unable to get current working directory, using {prev_dir}"
        )
